...
ActiveRecord::Schema.define(version: 20170515083617) do
  ...
  create_table "gtid_executed", primary_key: ["source_uuid", "interval_start"], force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1 STATS_PERSISTENT=0" do |t|
  ...
  create_table "help_category", primary_key: "help_category_id", id: :integer, limit: 2, unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 STATS_PERSISTENT=0", comment: "help categories" do |t|
  ...
  create_table "help_keyword", primary_key: "help_keyword_id", id: :integer, unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 STATS_PERSISTENT=0", comment: "help keywords" do |t|
    t.string "name", limit: 64, null: false
    t.index ["name"], name: "name", unique: true, using: :btree
  end
  ...
  create_table "help_topic", primary_key: "help_topic_id", id: :integer, unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 STATS_PERSISTENT=0", comment: "help topics" do |t|
    t.string  "name",             limit: 64,    null: false
  ...
  create_table "slave_master_info", primary_key: "Channel_name", id: :string, limit: 64, comment: "The channel on which the slave is connected to a source. Used in Multisource Replication", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 STATS_PERSISTENT=0", comment: "Master Information" do |t|
    ...
    t.text    "Master_log_name",        limit: 65535, null: false, collation: "utf8_bin", comment: "The name of the master binary log currently being read from the master."
    ...
    t.text    "User_name",              limit: 65535,              collation: "utf8_bin", comment: "The user name used to connect to the master."
    t.text    "User_password",          limit: 65535,              collation: "utf8_bin", comment: "The password used to connect to the master."
    ...
    t.text    "Ssl_ca",                 limit: 65535,              collation: "utf8_bin", comment: "The file used for the Certificate Authority (CA) certificate."
    t.text    "Ssl_capath",             limit: 65535,              collation: "utf8_bin", comment: "The path to the Certificate Authority (CA) certificates."
    t.text    "Ssl_cert",               limit: 65535,              collation: "utf8_bin", comment: "The name of the SSL certificate file."
    t.text    "Ssl_cipher",             limit: 65535,              collation: "utf8_bin", comment: "The name of the cipher in use for the SSL connection."
    t.text    "Ssl_key",                limit: 65535,              collation: "utf8_bin", comment: "The name of the SSL key file."
    ...
    t.text    "Bind",                   limit: 65535,              collation: "utf8_bin", comment: "Displays which interface is employed when connecting to the MySQL server"
    t.text    "Ignored_server_ids",     limit: 65535,              collation: "utf8_bin", comment: "The number of server IDs to be ignored, followed by the actual server IDs"
    t.text    "Uuid",                   limit: 65535,              collation: "utf8_bin", comment: "The master server uuid."
    t.bigint  "Retry_count",                          null: false,                        comment: "Number of reconnect attempts, to the master, before giving up.",                             unsigned: true
    t.text    "Ssl_crl",                limit: 65535,              collation: "utf8_bin", comment: "The file used for the Certificate Revocation List (CRL)"
    t.text    "Ssl_crlpath",            limit: 65535,              collation: "utf8_bin", comment: "The path used for Certificate Revocation List (CRL) files"
    ...
    t.text    "Tls_version",            limit: 65535,              collation: "utf8_bin", comment: "Tls version"
  end
  ...
  create_table "slave_relay_log_info", primary_key: "Channel_name", id: :string, limit: 64, comment: "The channel on which the slave is connected to a source. Used in Multisource Replication", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 STATS_PERSISTENT=0", comment: "Relay Log Information" do |t|
    ...
    t.text    "Relay_log_name",    limit: 65535, null: false, collation: "utf8_bin", comment: "The name of the current relay log file."
    t.bigint  "Relay_log_pos",                   null: false,                        comment: "The relay log position of the last executed event.",                                            unsigned: true
    t.text    "Master_log_name",   limit: 65535, null: false, collation: "utf8_bin", comment: "The name of the master binary log file from which the events in the relay log file were read."
  ...
  create_table "slave_worker_info", primary_key: ["Channel_name", "Id"], force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 STATS_PERSISTENT=0", comment: "Worker Information" do |t|
    ...
    t.text    "Relay_log_name",             limit: 65535, null: false, collation: "utf8_bin"
    t.bigint  "Relay_log_pos",                            null: false,                                                                                                                             unsigned: true
    t.text    "Master_log_name",            limit: 65535, null: false, collation: "utf8_bin"
    t.bigint  "Master_log_pos",                           null: false,                                                                                                                             unsigned: true
    t.text    "Checkpoint_relay_log_name",  limit: 65535, null: false, collation: "utf8_bin"
    t.bigint  "Checkpoint_relay_log_pos",                 null: false,                                                                                                                             unsigned: true
    t.text    "Checkpoint_master_log_name", limit: 65535, null: false, collation: "utf8_bin"
    ...
    t.binary  "Checkpoint_group_bitmap",    limit: 65535, null: false
  ...
  create_table "time_zone", primary_key: "Time_zone_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 STATS_PERSISTENT=0", comment: "Time zones" do |t|
